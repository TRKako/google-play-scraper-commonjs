...
const { checkFinished, processFullDetailApps } = require('./utils/processPages.js');
...
function buildUrl(opts) {
  ...
  const path = isNaN(devId) ? '/developer' : '/dev';
  ...
  const fullURL = `${baseUrl}${path}?${qs.stringify(queryString)}`;
