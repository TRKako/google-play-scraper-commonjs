...
const scriptData = require('./utils/scriptData.js');
const { BASE_URL, constants } = require('./constants.js');
 ...
 * @param {array} reviews The reviews to be formatted
...
/**
 * This object allows us to differ between
...
/**
 * This method allows us to get the body for the review request
 *
...
function getBodyForRequests({
  ...
  /* The body is slightly different for the initial and paginated requests */
  const formBody = {
